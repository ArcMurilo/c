                             /* Chapter 4 - Program 5 - COMPARES.C */
...
float r = 12.987, s = 12.987, t = 12.987;
   ...
   if (x > z)  a = 'A';   /* This will set a =     ?                      */
   if (!(x > z)) a = 'B'; /* This will change nothing            */
   if (b <= c) r = 0.0;   /* This will set r =      ?                     */
   if (r != s) t = c/2;   /* This will set t =   ?                       */

                         /* Second group of compare statements   */

   if (x = (r != s)) z = 1000; /* This will set x = some positive
                                  number and z = 1000            */
   if (x = y) z = 222;   /* This sets x = ? , and z = ?          */
   if (x != 0) z = 333;  /* This sets z =    ?                    */
   if (x) z = 444;       /* This sets z = 444                    */

                         /* Third group of compare statements    */

   x = y = z = 77;
   if ((x == y) && (x == 77)) z = 33; /* This sets z =  ?       */
   if ((x > y) || (z > 12))   z = 22; /* This sets z =  ?       */
   ...
   if (x != x)  z = 27.345;  /*  ?  gets changed             */
   if (x = 0)   z = 27.345;  /* This sets x = ? , z = ?  */
